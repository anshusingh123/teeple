<?php
// $Id: search-theme-form.tpl.php,v 1.1.2.2 2009/12/13 01:22:02 ipwa Exp $
...
?>
	...
	<input type="image" name="op" alt="Submit" src="<?php print path_to_theme() ?>/images/search-trans.png" id="searchsubmit"/>
